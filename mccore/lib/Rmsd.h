...
namespace mccore
{
   ...
   * superimposition of groups of points.  Computation is based on the
   * algorithm by Kabsch, 1976.
   *
   * @author Martin Larose (<a href="larosem@iro.umontreal.ca">larosem@iro.umontreal.ca</a>)
   * @version $Id: Rmsd.h,v 1.7.2.1 2004-12-25 02:46:05 larosem Exp $
   */
  class Rmsd 
  {
  private:
...
//       nrot = jacobi (rr, 3, mu, a);
	...
	* HomogeneousTransfo().translate(-center_a);
     ...
     * This method is for those concerned with speen and do not want
