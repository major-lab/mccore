...
// $Revision: 1.2.2.1 $
// $Id: Rmsd.cc,v 1.2.2.1 2004-12-25 02:45:56 larosem Exp $
// 
...
namespace mccore
{
  ...
  int 
  Rmsd::jacobi (double *a, int n, double *d, double *v)
  {
    int ip, iq, j;
    double *b;
    double *z;
  ...
  void 
  Rmsd::jacobiRotate (double *a, int i, int j, int k, int l, int n, 
		      double s, double tau)
  {
    double g;
    double h;
