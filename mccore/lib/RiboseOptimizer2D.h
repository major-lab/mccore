...
#ifndef __RiboseOptimizer2D_h_
#define __RiboseOptimizer2D_h_
...
namespace mccore
{
   ...
   * 2D torsion space < rho, chi >. Base must contains C1'.
   *
   * @author Philippe Thibault <thibaup@iro.umontreal.ca>
   */
  class RiboseOptimizer2D : public RiboseBuilder
  {
  protected:
  ...
  public:
     ...
     */
    RiboseOptimizer2D (Residue::const_iterator c24,
     ...
     * 5' phosphate residue must contains O5' linked from C5' toward 5',
     * as 3' phosphate residue must contains O3' linked from C3'
     * toward 3'.
     ...
     * @param quality Id for quality function to be used.
     */
    RiboseOptimizer2D (Residue* base,
		       Residue* p5p,
		       Residue* p3p,
		       char quality = QFCT_BOND);
     ...
     */
    RiboseOptimizer2D (const RiboseOptimizer2D &right);

    /**
     * Clones the object.
     * @return a copy of the object.
     */
    virtual RiboseBuilder* clone () const { return new RiboseOptimizer2D (*this); }

    /**
     * Destructs the object.
     */
    virtual ~RiboseOptimizer2D () { }
     ...
     * @return itself.
     */
    virtual RiboseOptimizer2D& operator= (const RiboseOptimizer2D &right);
     ...
     * a simplified cyclic coordinates method in 2D torsion space.
  ...
  protected:
     ...
     * < rho, chi > order, and returns quality.
     * @param p torsion value array < rho, chi >.
