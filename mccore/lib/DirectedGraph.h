...
#ifndef _mccore_DirectedGraph_h_
#define _mccore_DirectedGraph_h_
...
namespace mccore
{
   ...
   * @version $Id: DirectedGraph.h,v 1.8.2.1 2004-12-13 07:44:39 larosem Exp $
   */
  template< class V,
	    class E,
	    class VW = float,
  ...
  class DirectedGraph : public Graph< V, E, VW, EW, Vertex_Comparator>
  {
  ...
  public:
     ...
     */
    DirectedGraph (const DirectedGraph &right) : Graph (right) { }
    ...
    {
      return new DirectedGraph< V, VW, E, EW, Vertex_Comparator> (*this);
    }
     ...
     * @return itself.
     */
    DirectedGraph& operator= (const DirectedGraph &right)
    {
      if (this != &right)
	{
