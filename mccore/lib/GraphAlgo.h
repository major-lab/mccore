...
// $Revision: 1.5 $
// $Id: GraphAlgo.h,v 1.5 2004-09-02 20:52:28 larosem Exp $
...
namespace mccore
{
   ...
   * @version $Id: GraphAlgo.h,v 1.5 2004-09-02 20:52:28 larosem Exp $
   */
  class GraphAlgo 
  {
  ...
  public:
    ...
    template< class node_type, 
	      ...
	      class node_comparator >
    static void 
    minimumSpanningTree (UndirectedAbstractGraph< node_type, edge_type, node_comparator > &graph, vector< pair< int, int > > &edge_nodes) 
    {
