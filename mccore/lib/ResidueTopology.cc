//                              -*- Mode: C++ -*- 
// ResidueTopology.cc
// Copyright © 2003-04, 07 Laboratoire de Biologie Informatique et Théorique
//                     Université de Montréal.
// Author           : Patrick Gendron
// Created On       : Fri Mar 21 15:30:27 2003
// $Revision: 1.9 $
// $Id: ResidueTopology.cc,v 1.9 2007-01-09 00:05:36 larosem Exp $
// 
...
namespace mccore
{
  ...
  map< const ResidueType*, UndirectedGraph< const AtomType*, pair< const AtomType*, const AtomType* > > > ResidueTopology::topologies;
  

  const UndirectedGraph< const AtomType*, pair< const AtomType*, const AtomType* > >* 
  ...
  ResidueTopology::init (const ResidueType* type) 
  {
    if (type == ResidueType::rRA)
      {
	UndirectedGraph< const AtomType*, pair< const AtomType*, const AtomType* > > &g = topologies[type];
	...
	// BACKBONE
	g.connect (AtomType::aC1p, AtomType::aC2p, make_pair (AtomType::aC1p, AtomType::aC2p));
	g.connect (AtomType::aC1p, AtomType::aH1p, make_pair (AtomType::aC1p, AtomType::aH1p));
	g.connect (AtomType::aC2p, AtomType::aC3p, make_pair (AtomType::aC2p, AtomType::aC3p));
	g.connect (AtomType::aC2p, AtomType::aH2p, make_pair (AtomType::aC2p, AtomType::aH2p));
	g.connect (AtomType::aC2p, AtomType::aO2p, make_pair (AtomType::aC2p, AtomType::aO2p));
	g.connect (AtomType::aO2p, AtomType::aHO2p, make_pair (AtomType::aO2p, AtomType::aHO2p));
	g.connect (AtomType::aC3p, AtomType::aC4p, make_pair (AtomType::aC3p, AtomType::aC4p));
	g.connect (AtomType::aC3p, AtomType::aH3p, make_pair (AtomType::aC3p, AtomType::aH3p));
	g.connect (AtomType::aC3p, AtomType::aO3p, make_pair (AtomType::aC3p, AtomType::aO3p));
	g.connect (AtomType::aO3p, AtomType::aHO3p, make_pair (AtomType::aO3p, AtomType::aHO3p));
	g.connect (AtomType::aC4p, AtomType::aO4p, make_pair (AtomType::aC4p, AtomType::aO4p));
	g.connect (AtomType::aC4p, AtomType::aH4p, make_pair (AtomType::aC4p, AtomType::aH4p));
	g.connect (AtomType::aC4p, AtomType::aC5p, make_pair (AtomType::aC4p, AtomType::aC5p));
	g.connect (AtomType::aC5p, AtomType::aO5p, make_pair (AtomType::aC5p, AtomType::aO5p));
	g.connect (AtomType::aC5p, AtomType::a1H5p, make_pair (AtomType::aC5p, AtomType::a1H5p));
	g.connect (AtomType::aC5p, AtomType::a2H5p, make_pair (AtomType::aC5p, AtomType::a2H5p));
	g.connect (AtomType::aO5p, AtomType::aP, make_pair (AtomType::aO5p, AtomType::aP));
	g.connect (AtomType::aP, AtomType::aO1P, make_pair (AtomType::aP, AtomType::aO1P));
	g.connect (AtomType::aP, AtomType::aO2P, make_pair (AtomType::aP, AtomType::aO2P));
	g.connect (AtomType::aO4p, AtomType::aC1p, make_pair (AtomType::aO4p, AtomType::aC1p));
	
	g.connect (AtomType::aN9, AtomType::aC1p, make_pair (AtomType::aN9, AtomType::aC1p));
	
	// SIDECHAIN
	g.connect (AtomType::aN1, AtomType::aC2, make_pair (AtomType::aN1, AtomType::aC2));
	g.connect (AtomType::aC2, AtomType::aN3, make_pair (AtomType::aC2, AtomType::aN3));
	g.connect (AtomType::aC2, AtomType::aH2, make_pair (AtomType::aC2, AtomType::aH2));
	g.connect (AtomType::aN3, AtomType::aC4, make_pair (AtomType::aN3, AtomType::aC4));
	g.connect (AtomType::aC4, AtomType::aC5, make_pair (AtomType::aC4, AtomType::aC5));
	g.connect (AtomType::aC4, AtomType::aN9, make_pair (AtomType::aC4, AtomType::aN9));
	g.connect (AtomType::aC5, AtomType::aC6, make_pair (AtomType::aC5, AtomType::aC6));
	g.connect (AtomType::aC5, AtomType::aN7, make_pair (AtomType::aC5, AtomType::aN7));
	g.connect (AtomType::aC6, AtomType::aN1, make_pair (AtomType::aC6, AtomType::aN1));
	g.connect (AtomType::aC6, AtomType::aN6, make_pair (AtomType::aC6, AtomType::aN6));
	g.connect (AtomType::aN6, AtomType::a1H6, make_pair (AtomType::aN6, AtomType::a1H6));
	g.connect (AtomType::aN6, AtomType::a2H6, make_pair (AtomType::aN6, AtomType::a2H6));
	g.connect (AtomType::aN7, AtomType::aC8, make_pair (AtomType::aN7, AtomType::aC8));
	g.connect (AtomType::aC8, AtomType::aN9, make_pair (AtomType::aC8, AtomType::aN9));
	g.connect (AtomType::aC8, AtomType::aH8, make_pair (AtomType::aC8, AtomType::aH8));
	
	g.connect (AtomType::aLP1, AtomType::aN1, make_pair (AtomType::aLP1, AtomType::aN1));
	g.connect (AtomType::aLP3, AtomType::aN3, make_pair (AtomType::aLP3, AtomType::aN3));
	g.connect (AtomType::aLP7, AtomType::aN7, make_pair (AtomType::aLP7, AtomType::aN7));
	...
	g.connect (AtomType::aN1, AtomType::aC1p, make_pair (AtomType::aN1, AtomType::aC1p));
	
	//SIDECHAIN	   
	g.connect (AtomType::aN1, AtomType::aC2, make_pair (AtomType::aN1, AtomType::aC2));
	g.connect (AtomType::aC2, AtomType::aN3, make_pair (AtomType::aC2, AtomType::aN3));
	g.connect (AtomType::aC2, AtomType::aO2, make_pair (AtomType::aC2, AtomType::aO2));
	g.connect (AtomType::aN3, AtomType::aC4, make_pair (AtomType::aN3, AtomType::aC4));
	g.connect (AtomType::aC4, AtomType::aN4, make_pair (AtomType::aC4, AtomType::aN4));
	g.connect (AtomType::aN4, AtomType::a1H4, make_pair (AtomType::aN4, AtomType::a1H4));
	g.connect (AtomType::aN4, AtomType::a2H4, make_pair (AtomType::aN4, AtomType::a2H4));
	g.connect (AtomType::aC4, AtomType::aC5, make_pair (AtomType::aC4, AtomType::aC5));
	g.connect (AtomType::aC5, AtomType::aH5, make_pair (AtomType::aC5, AtomType::aH5));
	g.connect (AtomType::aC5, AtomType::aC6, make_pair (AtomType::aC5, AtomType::aC6));
	g.connect (AtomType::aC6, AtomType::aH6, make_pair (AtomType::aC6, AtomType::aH6));
	g.connect (AtomType::aC6, AtomType::aN1, make_pair (AtomType::aC6, AtomType::aN1));
	
	g.connect (AtomType::aLP3, AtomType::aN3, make_pair (AtomType::aLP3, AtomType::aN3));
	g.connect (AtomType::a1LP2, AtomType::aO2, make_pair (AtomType::a1LP2, AtomType::aO2));
	g.connect (AtomType::a2LP2, AtomType::aO2, make_pair (AtomType::a2LP2, AtomType::aO2));
	...
	// SIDECHAIN
	g.connect (AtomType::aN1, AtomType::aC2, make_pair (AtomType::aN1, AtomType::aC2));
	g.connect (AtomType::aN1, AtomType::aH1, make_pair (AtomType::aN1, AtomType::aH1));
	g.connect (AtomType::aC2, AtomType::aN3, make_pair (AtomType::aC2, AtomType::aN3));
	g.connect (AtomType::aC2, AtomType::aN2, make_pair (AtomType::aC2, AtomType::aN2));
	g.connect (AtomType::aN2, AtomType::a1H2, make_pair (AtomType::aN2, AtomType::a1H2));
	g.connect (AtomType::aN2, AtomType::a2H2, make_pair (AtomType::aN2, AtomType::a2H2));
	g.connect (AtomType::aN3, AtomType::aC4, make_pair (AtomType::aN3, AtomType::aC4));
	g.connect (AtomType::aC4, AtomType::aC5, make_pair (AtomType::aC4, AtomType::aC5));
	g.connect (AtomType::aC4, AtomType::aN9, make_pair (AtomType::aC4, AtomType::aN9));
	g.connect (AtomType::aC5, AtomType::aC6, make_pair (AtomType::aC5, AtomType::aC6));
	g.connect (AtomType::aC5, AtomType::aN7, make_pair (AtomType::aC5, AtomType::aN7));
	g.connect (AtomType::aC6, AtomType::aN1, make_pair (AtomType::aC6, AtomType::aN1));
	g.connect (AtomType::aC6, AtomType::aO6, make_pair (AtomType::aC6, AtomType::aO6));
	g.connect (AtomType::aN7, AtomType::aC8, make_pair (AtomType::aN7, AtomType::aC8));
	g.connect (AtomType::aC8, AtomType::aN9, make_pair (AtomType::aC8, AtomType::aN9));
	g.connect (AtomType::aC8, AtomType::aH8, make_pair (AtomType::aC8, AtomType::aH8));
	
	g.connect (AtomType::aLP3, AtomType::aN3, make_pair (AtomType::aLP3, AtomType::aN3));
	g.connect (AtomType::a1LP6, AtomType::aO6, make_pair (AtomType::a1LP6, AtomType::aO6));
	g.connect (AtomType::a2LP6, AtomType::aO6, make_pair (AtomType::a2LP6, AtomType::aO6));
	g.connect (AtomType::aLP7, AtomType::aN7, make_pair (AtomType::aLP7, AtomType::aN7));
	
	return true;
      }
    else if (type == ResidueType::rRI)
      {
	UndirectedGraph< const AtomType*, pair< const AtomType*, const AtomType* > > &g = topologies[type];
	...
	g.connect (AtomType::aC2, AtomType::aO2, make_pair (AtomType::aC2, AtomType::aO2));
	g.connect (AtomType::aN3, AtomType::aC4, make_pair (AtomType::aN3, AtomType::aC4));
	g.connect (AtomType::aN3, AtomType::aH3, make_pair (AtomType::aN3, AtomType::aH3));
	g.connect (AtomType::aC4, AtomType::aC5, make_pair (AtomType::aC4, AtomType::aC5));
	g.connect (AtomType::aC4, AtomType::aO4, make_pair (AtomType::aC4, AtomType::aO4));
	g.connect (AtomType::aC5, AtomType::aC6, make_pair (AtomType::aC5, AtomType::aC6));
	g.connect (AtomType::aC5, AtomType::aH5, make_pair (AtomType::aC5, AtomType::aH5));
	g.connect (AtomType::aC6, AtomType::aN1, make_pair (AtomType::aC6, AtomType::aN1));
	g.connect (AtomType::aC6, AtomType::aH6, make_pair (AtomType::aC6, AtomType::aH6));
	...
	g.connect (AtomType::a1LP2, AtomType::aO2, make_pair (AtomType::a1LP2, AtomType::aO2));
	g.connect (AtomType::a2LP2, AtomType::aO2, make_pair (AtomType::a2LP2, AtomType::aO2));
	g.connect (AtomType::a1LP4, AtomType::aO4, make_pair (AtomType::a1LP4, AtomType::aO4));
	g.connect (AtomType::a2LP4, AtomType::aO4, make_pair (AtomType::a2LP4, AtomType::aO4));
	...
	g.connect (AtomType::aC1p, AtomType::aH1p, make_pair (AtomType::aC1p, AtomType::aH1p));
	g.connect (AtomType::aC2p, AtomType::aC3p, make_pair (AtomType::aC2p, AtomType::aC3p));
	g.connect (AtomType::aC2p, AtomType::a1H2p, make_pair (AtomType::aC2p, AtomType::a1H2p));
	g.connect (AtomType::aC2p, AtomType::a2H2p, make_pair (AtomType::aC2p, AtomType::a2H2p));
	g.connect (AtomType::aC3p, AtomType::aC4p, make_pair (AtomType::aC3p, AtomType::aC4p));
	g.connect (AtomType::aC3p, AtomType::aH3p, make_pair (AtomType::aC3p, AtomType::aH3p));
	g.connect (AtomType::aC3p, AtomType::aO3p, make_pair (AtomType::aC3p, AtomType::aO3p));
	g.connect (AtomType::aO3p, AtomType::aHO3p, make_pair (AtomType::aO3p, AtomType::aHO3p));
	...
	g.connect (AtomType::aC4, AtomType::aO4, make_pair (AtomType::aC4, AtomType::aO4));
	g.connect (AtomType::aC5, AtomType::aC6, make_pair (AtomType::aC5, AtomType::aC6));
	g.connect (AtomType::aC5, AtomType::aC5M, make_pair (AtomType::aC5, AtomType::aC5M));
	g.connect (AtomType::aC5M, AtomType::a1H5M, make_pair (AtomType::aC5M, AtomType::a1H5M));
	g.connect (AtomType::aC5M, AtomType::a2H5M, make_pair (AtomType::aC5M, AtomType::a2H5M));
	g.connect (AtomType::aC5M, AtomType::a3H5M, make_pair (AtomType::aC5M, AtomType::a3H5M));
	g.connect (AtomType::aC6, AtomType::aN1, make_pair (AtomType::aC6, AtomType::aN1));
	g.connect (AtomType::aC6, AtomType::aH6, make_pair (AtomType::aC6, AtomType::aH6));
  ...
  ResidueTopology::getOblSet (const ResidueType* type)
  {
    ...
    static const AtomType* DIOblSet[25] =
      {
	(const AtomType*)AtomType::aC1p, (const AtomType*)AtomType::aC2,  
	(const AtomType*)AtomType::aC2p, (const AtomType*)AtomType::aC3p, 
	(const AtomType*)AtomType::aC4,  (const AtomType*)AtomType::aC4p, 
    ...
    static const AtomType* RIOblSet[26] =
      {
	(const AtomType*)AtomType::aC1p, (const AtomType*)AtomType::aC2,
	(const AtomType*)AtomType::aC2p, (const AtomType*)AtomType::aC3p,
	(const AtomType*)AtomType::aC4,  (const AtomType*)AtomType::aC4p,
    ...
    if (type == ResidueType::rDI)
      {
	return set< const AtomType* > (DIOblSet, DIOblSet + sizeof(DIOblSet)/sizeof(const AtomType*));
      }
    if (type == ResidueType::rRI)
      {
	return set< const AtomType* > (RIOblSet, RIOblSet + sizeof(RIOblSet)/sizeof(const AtomType*));
      }
