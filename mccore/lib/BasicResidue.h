...
#ifndef _BasicResidue_h_
#define _BasicResidue_h_
...
namespace mccore {
  ...
  public:
     ...
     */
    BasicResidue (const BasicResidue &other);

    /**
     * Clones the residue.
     * @return the copy of the object.
     */
    virtual BasicResidue* clone () const; 

    /**
     * Destroys the object.
     */
    virtual ~BasicResidue ();
     ...
     * @return itself.
     */
    virtual BasicResidue& operator= (const BasicResidue &other);
     ...
     * false otherwise.
     */
    virtual bool operator== (const BasicResidue &other) const;
  ...
  protected:
     ...
     * ([BasicResidue::size_type]) accessor.
     *
     * @author Martin Larose <larosem@iro.umontreal.ca>
     */
    class ResidueIterator
    {
      friend class BasicResidue::ResidueConstIterator;
    ...
    public:
       ...
       */
      ResidueIterator (BasicResidue *r, AtomMap::iterator p, AtomSet *f = 0);
	...
	return (res < right.res ||
       ...
       */
      operator BasicResidue* () { return res; }
    };
    ...
    class ResidueConstIterator
    {
      friend class BasicResidue::ResidueIterator;
    ...
    public:
       ...
       * @param f the filter function.
       */
      ResidueConstIterator (const BasicResidue *r,
	...
	return (res < right.res ||
       ...
       * @return the residue pointed by the iterator.
       */
      operator const BasicResidue* () const { return res; }
   ...
   * @return the used output stream.
   */
  ostream& operator<< (ostream &os, const BasicResidue &r);
