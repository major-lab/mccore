// Algo.h
// Copyright © 2001-06, 2014 Laboratoire de Biologie Informatique et Theorique.
...
namespace mccore
{
  ...
  public:
     ...
     */
    template< class iter_type >
    static void extractContacts (vector< pair< iter_type, iter_type > > &result,
                                 iter_type begin,
                                 iter_type end,
                                 const RDATypeFilter< iter_type > &filter,
                                 float cutoff = 5.0)
    {
