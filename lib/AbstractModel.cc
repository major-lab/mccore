// AbstractModel.cc
// Copyright © 2004-05, 2014 Laboratoire de Biologie Informatique et Theorique
...
namespace mccore
{
  ...
  AbstractModel& AbstractModel::operator= (const AbstractModel &right)
  {
    if (this != &right)
    {
      delete residueFM;
  ...
  void AbstractModel::setResidueFM (const ResidueFactoryMethod *fm)
  {
    delete residueFM;
    residueFM = 0 == fm ? new ExtendedResidueFM () : fm->clone ();
  }
  ...
  AbstractModel::iterator AbstractModel::find (const ResId &id)
  {
    iterator it;
  ...
  AbstractModel::const_iterator AbstractModel::find (const ResId &id) const
  {
    const_iterator it;
  ...
  void AbstractModel::addHLP (bool overwrite)
  {
    iterator it;
  ...
  void AbstractModel::removeOptionals ()
  {
    iterator it;
  ...
  void AbstractModel::removeAminoAcid ()
  {
  ...
  void AbstractModel::removeNucleicAcid ()
  {
    iterator modelIt;
  ...
  void AbstractModel::removeWater ()
  {
  ...
  void AbstractModel::keepAminoAcid ()
  {
    iterator modelIt;
  ...
  void AbstractModel::keepNucleicAcid ()
  {
    iterator modelIt;
  ...
  void AbstractModel::keep (const ResidueType* rtype)
  {
    iterator modelIt = this->begin ();
  ...
  oPdbstream& AbstractModel::output (oPdbstream &ops) const
  {
    const_iterator cit;
    char chainId;
